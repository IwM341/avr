...
Module {
    ...
    property stringList qtConfig: ["shared","shared","release","c++11","c++14","c++17","c++1z","concurrent","dbus","no-pkg-config","separate_debug_info","stl"]
    property path binPath: "D:/Soft/Prog/5.15.2/mingw81_64/bin"
    property path installPath: "D:/Soft/Prog/5.15.2/mingw81_64/bin"
    property path incPath: "D:/Soft/Prog/5.15.2/mingw81_64/include"
    property path libPath: "D:/Soft/Prog/5.15.2/mingw81_64/lib"
    property path libExecPath: undefined
    property path qmlLibExecPath: "D:/Soft/Prog/5.15.2/mingw81_64/bin"
    property path pluginPath: "D:/Soft/Prog/5.15.2/mingw81_64/plugins"
    property string mkspecName: "win32-g++"
    property path mkspecPath: "D:/Soft/Prog/5.15.2/mingw81_64/mkspecs/win32-g++"
    ...
    property path docPath: "D:/Soft/Prog/Docs/Qt-5.15.2"
    ...
    property string libFilePathRelease: "D:/Soft/Prog/5.15.2/mingw81_64/lib/libQt5Core.a"
    ...
    property stringList moduleConfig: ["lex","yacc","debug","exceptions","depend_includepath","testcase_targets","import_plugins","import_qpa_plugin","windows","prepare_docs","qt_docs_targets","qt_build_extra","file_copies","qmake_use","qt","warn_on","link_prl","debug_and_release","precompile_header","shared","shared","no_plugin_manifest","win32","mingw","gcc","copy_dir_files","sse2","aesni","sse3","ssse3","sse4_1","sse4_2","compile_examples","force_debug_info","largefile","precompile_header","rdrnd","shani","x86SimdAlways","prefix_build","force_independent","utf8_source","create_prl","link_prl","no_private_qt_headers_warning","QTDIR_build","qt_example_installs","testcase_exceptions","warning_clean","debug","DebugBuild","Debug","build_pass","exceptions","qt_tracepoints","moc","resources","simd","optimize_full","metatypes","install_metatypes","no_core_dep","pcre2","generated_privates","relative_qt_rpath","git_build","target_qt","c++11","strict_c++","c++14","c++1z","c99","c11","separate_debug_info","qt_install_headers","need_fwd_pri","qt_install_module","create_cmake","skip_target_version_ext","compiler_supports_fpmath","create_pc","debug","DebugBuild","Debug","build_pass","have_target","dll","no_plist","exclusive_builds","debug_info","no_autoqmake","thread"]
    Properties {
    ...
    cpp.includePaths: {
        var paths = ["D:/Soft/Prog/5.15.2/mingw81_64/include","D:/Soft/Prog/5.15.2/mingw81_64/include/QtCore"];
    ...
    cpp.staticLibraries: {
        ...
        if (qbs.targetOS.contains('windows') && !product.consoleApplication) {
            libs = libs.concat(qtBuildVariant === "debug"
                               ? undefined : ["D:/Soft/Prog/5.15.2/mingw81_64/lib/libqtmain.a"]);
        }
    ...
    Group {
        files: "D:/Soft/Prog/5.15.2/mingw81_64/lib/metatypes/qt5core_metatypes.json"
